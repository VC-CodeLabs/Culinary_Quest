...
For successful selections, the output should be:
```
{
...
Submissions
👍Please have the solution either emailed to me or a PR submitted to GitHub by Friday June 7th, by midnight👍
